...
type LightHandlerClient interface {
	...
	GetByDevice(ctx context.Context, in *integration.Integration, opts ...grpc.CallOption) (LightHandler_GetByDeviceClient, error)
	GetByIntegration(ctx context.Context, in *integration.Integration, opts ...grpc.CallOption) (LightHandler_GetByIntegrationClient, error)
}
...
func (c *lightHandlerClient) SetDesiredState(ctx context.Context, in *Light, opts ...grpc.CallOption) (*Light, error) {
	out := new(Light)
	err := c.cc.Invoke(ctx, "/light.LightHandler/SetDesiredState", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lightHandlerClient) SetState(ctx context.Context, in *Light, opts ...grpc.CallOption) (*Light, error) {
	out := new(Light)
	err := c.cc.Invoke(ctx, "/light.LightHandler/SetState", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lightHandlerClient) Create(ctx context.Context, in *Light, opts ...grpc.CallOption) (*Light, error) {
	out := new(Light)
	err := c.cc.Invoke(ctx, "/light.LightHandler/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lightHandlerClient) GetByDevice(ctx context.Context, in *integration.Integration, opts ...grpc.CallOption) (LightHandler_GetByDeviceClient, error) {
	stream, err := c.cc.NewStream(ctx, &_LightHandler_serviceDesc.Streams[0], "/light.LightHandler/GetByDevice", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *lightHandlerClient) GetByIntegration(ctx context.Context, in *integration.Integration, opts ...grpc.CallOption) (LightHandler_GetByIntegrationClient, error) {
	stream, err := c.cc.NewStream(ctx, &_LightHandler_serviceDesc.Streams[1], "/light.LightHandler/GetByIntegration", opts...)
	if err != nil {
		return nil, err
	}
...
type LightHandlerServer interface {
	...
	GetByDevice(*integration.Integration, LightHandler_GetByDeviceServer) error
	GetByIntegration(*integration.Integration, LightHandler_GetByIntegrationServer) error
...
func (UnimplementedLightHandlerServer) GetByDevice(*integration.Integration, LightHandler_GetByDeviceServer) error {
	return status.Errorf(codes.Unimplemented, "method GetByDevice not implemented")
}
func (UnimplementedLightHandlerServer) GetByIntegration(*integration.Integration, LightHandler_GetByIntegrationServer) error {
...
func _LightHandler_SetDesiredState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/light.LightHandler/SetDesiredState",
	}
...
func _LightHandler_SetState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/light.LightHandler/SetState",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _LightHandler_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/light.LightHandler/Create",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _LightHandler_serviceDesc = grpc.ServiceDesc{
	ServiceName: "light.LightHandler",
